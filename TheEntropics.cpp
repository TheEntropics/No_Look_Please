        ...
        for(int i = 0; i < Nplayer; i++)
        {
            ...
            while(!in.eof())
            {
                ...
                if(n == v.at(i).name || n == v.at(i).name + "'s")
                {
                    ...
                    // Se il nome � uguale all'ultima parola sopra
                    if(n == NomeDelMorto || n == NomeDelMorto + "'s")
                    {
                        in >> n;
                        if(n == "was" || n == "almost" || n == "ate" || n == "blew" || n == "sank" || n == "cratered." ||
                           n == "melted" || n == "tripped")
                        {
                            v.at(i).death = v.at(i).death + 1;
                            if(n == "blew" || n == "sank" || n == "cratered." || n == "melted" || n == "tripped")
                                v.at(i).autokill++;
                        }
                    }

                    // Se � morto
                    else if(n == "was" || n == "almost" || n == "ate" || n == "blew" || n == "sank" || n == "cratered." ||
                            n == "melted" || n == "tripped")
                    {
                        v.at(i).death = v.at(i).death + 1;
                        if(n == "blew" || n == "sank" || n == "cratered." || n == "melted" || n == "tripped")
